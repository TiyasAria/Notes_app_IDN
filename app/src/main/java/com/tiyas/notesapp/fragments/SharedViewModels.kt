package com.tiyas.notesapp.fragments
...
/**
 * langkah ke 9 membuat sharedview model yang akan dipanggil berulang2
 */
class SharedViewModels(application: Application) : AndroidViewModel(application) {
    ...
    //    membuat variabel untuk merubah warna dari priority
